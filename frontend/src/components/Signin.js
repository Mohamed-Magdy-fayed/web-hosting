  ...
  return (
    <div className='grid grid-cols-2 items-center min-h-screen gap-12'>
      ...
      <div className='flex flex-col gap-4 justify-self-start text-center shadow-md rounded-lg border-t-2 border-t-green'>
        <h1 className='p-2 rounded-t-lg text-2xl font-bold'>Login to your <span className=' text-blue'>account</span></h1>
        <form className='flex flex-col p-4 gap-4 min-w-[30rem] rounded-b-lg'>
          ...
          <div className='flex justify-around'>
            <Link className=' text-green hover:text-orange' to='/register'>Need an account?</Link>
            <Link className=' text-red hover:text-orange' to='/resetpassword'>Forgot your password?</Link>
          </div>
